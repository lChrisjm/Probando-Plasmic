...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: KfA1qxsT0nvT/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Xi9P3hSTv1Kc/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: OYm1U4kK8Xg3/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__qcCtt)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__yrWkj)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___1UCqM)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__thgH)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__yGdth)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,

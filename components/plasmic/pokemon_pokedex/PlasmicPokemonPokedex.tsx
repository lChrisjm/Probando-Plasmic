...
// Plasmic Project: utuuGbnQ9qDAqCkDiDrqxv
// Component: n_7bHi5Ag-kU
...
import PageLayout from "../../PageLayout"; // plasmic-import: KfA1qxsT0nvT/component
...
import projectcss from "./plasmic.module.css"; // plasmic-import: utuuGbnQ9qDAqCkDiDrqxv/projectcss
import sty from "./PlasmicPokemonPokedex.module.css"; // plasmic-import: n_7bHi5Ag-kU/css
...
function PlasmicPokemonPokedex__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    getPokemon: usePlasmicDataOp(() => {
      return {
        sourceId: "eJeiPqrQ846tB2ZUq1oQ7S",
        opId: "a9849e24-e7dc-4391-9745-308ad7170888",
        userArgs: {},
        cacheKey: `plasmic.$.a9849e24-e7dc-4391-9745-308ad7170888.$.`,
            ...
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__lVvl)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                        ...
                        $steps["useIntegration"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "eJeiPqrQ846tB2ZUq1oQ7S",
                                  opId: "bfaf55b3-06ae-492e-a4e0-076a4f34a425",
                                  userArgs: {
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__tjyCp)}
                    >
                      {(() => {
                        const child$Props = {
                          ...
                          data: {
                            sourceId: "eJeiPqrQ846tB2ZUq1oQ7S",
                            opId: "df5f5a1b-ee0d-4736-8991-e87ee2c842eb",
                            userArgs: {},
                            cacheKey: `plasmic.$.${(() => {
                              try {
                                return "getSchema";
                            ...
                            })()}.$.KDXEE60fMLr6.$.df5f5a1b-ee0d-4736-8991-e87ee2c842eb.$.`,
                            invalidatedKeys: null,
                            roleId: null
                          },
                          dataFormItems: (() => {
                            ...
                            $steps["defaultSubmit"] = true
                              ? (() => {
                                  const actionArgs = {
                                    dataOp: {
                                      sourceId: "eJeiPqrQ846tB2ZUq1oQ7S",
                                      opId: "efeefadb-9bcc-439a-a810-575a33c0839d",
                                      userArgs: {
                  ...
                  <AntdModal
                      ...
                      $steps["postgresUpdateMany"] = true
                        ? (() => {
                            const actionArgs = {
                              dataOp: {
                                sourceId: "eJeiPqrQ846tB2ZUq1oQ7S",
                                opId: "70aeab43-d305-4c0a-b50f-b1f7997ea22f",
                                userArgs: {
                    ...
                    wrapClassName={classNames({
                      [sty["pcls_p2ThyFm1QOPX"]]: true
                    })}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__eqFh)}
                    >
                      {(() => {
                        const child$Props = {
                          className: classNames(
                          ...
                          data: {
                            sourceId: "eJeiPqrQ846tB2ZUq1oQ7S",
                            opId: "eeffbeef-0a30-4440-b754-ff693b06cb91",
                            userArgs: {
                            ...
                            })()}.$.M0dRnOz3ifrI.$.eeffbeef-0a30-4440-b754-ff693b06cb91.$.`,
                            invalidatedKeys: null,
                            roleId: null
                          },
                          dataFormItems: (() => {
